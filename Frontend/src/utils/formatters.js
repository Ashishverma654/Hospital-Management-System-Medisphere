...
export const getStatusColor = (status) => {
  const colors = {
    ...
    missed: { bg: 'bg-rose-100', text: 'text-rose-800' },
    low: { bg: 'bg-slate-100', text: 'text-slate-800' },
    medium: { bg: 'bg-amber-100', text: 'text-amber-800' },
    high: { bg: 'bg-orange-100', text: 'text-orange-800' },
    critical: { bg: 'bg-red-100', text: 'text-red-800' },
    ordered: { bg: 'bg-slate-100', text: 'text-slate-800' },
    consultation: { bg: 'bg-blue-100', text: 'text-blue-800' },
    lab: { bg: 'bg-cyan-100', text: 'text-cyan-800' },
    pharmacy: { bg: 'bg-emerald-100', text: 'text-emerald-800' },
    ward: { bg: 'bg-orange-100', text: 'text-orange-800' },
    ...
    reportReady: { bg: 'bg-indigo-100', text: 'text-indigo-800' },
    reportAvailableForPickup: { bg: 'bg-orange-100', text: 'text-orange-800' },
    reportReleasedToPortal: { bg: 'bg-emerald-100', text: 'text-emerald-800' },
